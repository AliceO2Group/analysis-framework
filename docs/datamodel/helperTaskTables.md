...
##  o2-analysis-fwdtrack-propagation
Code file: <a href="https://github.com/AliceO2Group/O2Physics/tree/master//Common/TableProducer//fwdtrackPropagation.cxx" target="_blank">fwdtrackPropagation.cxx</a>
<div>

  <button class="myaccordion"><i class="fa fa-table"></i> o2::aod::StoredPropagatedFwdTracks</button>
  <div class="panel">
    <div>

    </div>
    <div>
      Header file: <a href="https://github.com/AliceO2Group/O2Physics/tree/master//Common/DataModel/PropagatedFwdTrackTables.h" target="_blank">Common/DataModel/PropagatedFwdTrackTables.h</a>
    </div>
    <table class=DataModel>
      <tr>
        <th>Name</th>
      ...
      <tr>
        <td>o2::aod::propfwdtrack::FwdTrackId</td>
        <td>I</td>
        <td>fwdtrackId</td>
        <td>int32</td>
      ...
      <tr>
        <td>o2::aod::propfwdtrack::MCHTrackId</td>
        <td>I</td>
        <td>matchMCHTrackId</td>
        <td>int</td>
        <td>Index of matched MCH track for GlobalMuonTracks and GlobalForwardTracks</td>
      </tr>
      <tr>
      ...
      <tr>
        <td>o2::aod::propfwdtrack::CXXatDCA</td>
        <td></td>
        <td>cXXatDCA</td>
        <td>float</td>
        <td>DCAx resolution squared at DCA</td>
      </tr>
      <tr>
        <td>o2::aod::propfwdtrack::CYYatDCA</td>
        <td></td>
        <td>cYYatDCA</td>
        <td>float</td>
        <td>DCAy resolution squared at DCA</td>
      </tr>
      <tr>
        <td>o2::aod::propfwdtrack::CXYatDCA</td>
        <td></td>
        <td>cXYatDCA</td>
        <td>float</td>
        <td>correlation term of DCAx,y resolution at DCA</td>
      </tr>
      <tr>
        <td>o2::aod::propfwdtrack::EtaMatchedMCHMID</td>
        <td></td>
        <td>etaMatchedMCHMID</td>
        <td>float</td>
        <td>eta of MCH-MID track in MFT-MCH-MID track at PV</td>
      </tr>
      <tr>
        <td>o2::aod::propfwdtrack::PhiMatchedMCHMID</td>
        <td></td>
        <td>phiMatchedMCHMID</td>
        <td>float</td>
        <td>phi of MCH-MID track in MFT-MCH-MID track at PV</td>
      </tr>
      <tr>
        <td>o2::aod::propfwdtrack::IsAssociatedToMPC</td>
        <td></td>
        <td>isAssociatedToMPC</td>
        <td>bool</td>
        <td>is assigned to the most probable collision (relevant to TTCA)</td>
      </tr>
      <tr>
        <td>o2::aod::propfwdtrack::IsAmbiguous</td>
        <td></td>
        <td>isAmbiguous</td>
        <td>bool</td>
        <td>is ambiguous (relevant to TTCA)</td>
      </tr>
    </table>
  </div>

  <button class="myaccordion"><i class="fa fa-table"></i> o2::aod::StoredPropagatedFwdTracksCov</button>
  <div class="panel">
    <div>
...
<div>
  ...
  <div class="panel">
    ...
    <table class=DataModel>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::CollisionId</td>
        <td>I</td>
        <td>collisionId</td>
        <td>int32</td>
        <td>Pointer into Collisions</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::FwdTrackId</td>
        <td>I</td>
        <td>fwdtrackId</td>
        <td>int32</td>
        <td>FwdTrack index</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::TrackType</td>
        <td></td>
        <td>trackType</td>
        <td>uint8_t</td>
        <td>Type of track. See enum ForwardTrackTypeEnum</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::X</td>
        <td></td>
        <td>x</td>
        <td>float</td>
        <td>TrackParFwd parameter x</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Y</td>
        <td></td>
        <td>y</td>
        <td>float</td>
        <td>TrackParFwd parameter y</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Z</td>
        <td></td>
        <td>z</td>
        <td>float</td>
        <td>TrackParFwd propagation parameter z</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Phi</td>
        <td></td>
        <td>phi</td>
        <td>float</td>
        <td>TrackParFwd parameter phi; (i.e. pt pointing direction)</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Tgl</td>
        <td></td>
        <td>tgl</td>
        <td>float</td>
        <td>TrackParFwd parameter tan(\lamba); (\lambda = 90 - \theta_{polar})</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Signed1Pt</td>
        <td></td>
        <td>signed1Pt</td>
        <td>float</td>
        <td>TrackParFwd parameter: charged inverse transverse momentum; (q/pt)</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Px</td>
        <td>D</td>
        <td>px</td>
        <td>float</td>
        <td></td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Py</td>
        <td>D</td>
        <td>py</td>
        <td>float</td>
        <td></td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Pz</td>
        <td>D</td>
        <td>pz</td>
        <td>float</td>
        <td></td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Sign</td>
        <td>D</td>
        <td>sign</td>
        <td>short</td>
        <td>Sign of the track eletric charge</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Chi2</td>
        <td></td>
        <td>chi2</td>
        <td>float</td>
        <td>Track chi^2</td>
  ...
  <div class="panel">
    ...
    <table class=DataModel>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::SigmaX</td>
        <td></td>
        <td>sigmaX</td>
        <td>float</td>
        <td>Covariance matrix</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::SigmaY</td>
        <td></td>
        <td>sigmaY</td>
        <td>float</td>
        <td>Covariance matrix</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::SigmaPhi</td>
        <td></td>
        <td>sigmaPhi</td>
        <td>float</td>
        <td>Covariance matrix</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::SigmaTgl</td>
        <td></td>
        <td>sigmaTgl</td>
        <td>float</td>
        <td>Covariance matrix</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Sigma1Pt</td>
        <td></td>
        <td>sigma1Pt</td>
        <td>float</td>
        <td>Covariance matrix</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::RhoXY</td>
        <td></td>
        <td>rhoXY</td>
        <td>int8_t</td>
        <td>Covariance matrix in compressed form</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::RhoPhiY</td>
        <td></td>
        <td>rhoPhiY</td>
        <td>int8_t</td>
        <td>Covariance matrix in compressed form</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::RhoPhiX</td>
        <td></td>
        <td>rhoPhiX</td>
        <td>int8_t</td>
        <td>Covariance matrix in compressed form</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::RhoTglX</td>
        <td></td>
        <td>rhoTglX</td>
        <td>int8_t</td>
        <td>Covariance matrix in compressed form</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::RhoTglY</td>
        <td></td>
        <td>rhoTglY</td>
        <td>int8_t</td>
        <td>Covariance matrix in compressed form</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::RhoTglPhi</td>
        <td></td>
        <td>rhoTglPhi</td>
        <td>int8_t</td>
        <td>Covariance matrix in compressed form</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Rho1PtX</td>
        <td></td>
        <td>rho1PtX</td>
        <td>int8_t</td>
        <td>Covariance matrix in compressed form</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Rho1PtY</td>
        <td></td>
        <td>rho1PtY</td>
        <td>int8_t</td>
        <td>Covariance matrix in compressed form</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Rho1PtPhi</td>
        <td></td>
        <td>rho1PtPhi</td>
        <td>int8_t</td>
        <td>Covariance matrix in compressed form</td>
      ...
      <tr>
        <td>o2::aod::fwdtrackrealign::Rho1PtTgl</td>
        <td></td>
        <td>rho1PtTgl</td>
        <td>int8_t</td>
        <td>Covariance matrix in compressed form</td>
