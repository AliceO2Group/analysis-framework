...
<div>
  ...
  <button class="myaccordion"><i class="fa fa-map-pin"></i> o2::framework::expressions::SelectedCandidatesMcWithMl</button>
  <div class="panel">
    <ul>
        <li>o2::framework::expressions::SelectedCandidatesMcWithMl = soa::Join<o2::framework::expressions::soa::Join></li>
    </ul>
  </div>
