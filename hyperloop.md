...
*  Inside of _Enable dataset_ you can search for an active dataset by filtering by data type, collision system, anchor and period. And add it to your analysis by clicking on the button `✚ Add dataset to analysis`. Or you can click the button `ℹ️ All datasets` to be redirected to the **Datasets** ([section 2](#pookie)).
